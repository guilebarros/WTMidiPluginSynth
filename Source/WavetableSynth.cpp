...
void WavetableSynth::render(juce::AudioBuffer<float>& buffer, int startSample, int endSample)
{
    ...
    // copiando o firstChannel para todos os canais
...
float WavetableSynth::midiNoteNumberToFrequency(int midiNoteNumber)
{
    ...
    constexpr auto SEMITONES_IN_OCTAVE = 12.f;
    
    return A4_FREQUENCY * std::powf(2.f, (midiNoteNumber - A4_NOTE_NUMBER) / SEMITONES_IN_OCTAVE);
